        ...
        <>
            <div className="sidebar-area offcanvas offcanvas-end" id="menubar">
                <div className="offcanvas-header">
                    <a href="index.html" className="logo"> <img src="/brand-light.png" alt="logo" /></a>
                    <button type="button" className="btn-close" data-bs-dismiss="offcanvas"><i
                ...
                <div className="offcanvas-body sidebar__body">
                    ...
                    <div className="sidebar__contact-info mt-30">
                        ...
                        {/* Nigeria Office */}
                        <h6 className="text-white mt-3 mb-2">Nigeria</h6>
                        <ul>
                            <li><i className="fa-solid fa-location-dot"></i> <a href="#0">No 7, 6th Avenue Gwarinpa, Abuja</a></li>
                            <li className="py-2"><i className="fa-solid fa-phone-volume"></i> <a href="tel:+2349063504256">+234 9063504256</a></li>
                            <li><i className="fa-solid fa-paper-plane"></i> <a href="mailto:info@briieconsulting.com">info@briieconsulting.com</a></li>
                        </ul>

                        {/* Canada Office */}
                        <h6 className="text-white mt-4 mb-2">Canada</h6>
                        <ul>
                            <li><i className="fa-solid fa-location-dot"></i> <a href="#0">847 Jalna Blvd, London, Ontario Canada. N6E 2S2</a></li>
                            <li className="py-2"><i className="fa-solid fa-phone-volume"></i> <a href="tel:+2349063504256">+234 9063504256</a></li>
                            <li><i className="fa-solid fa-paper-plane"></i> <a href="mailto:info@briieconsulting.com">info@briieconsulting.com</a></li>
                        </ul>
                    </div>
