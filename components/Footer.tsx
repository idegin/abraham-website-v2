...
import { getBlogCategories } from "@/utils/queries/blog.query";
...
export default async function Footer({}: Props) {
    ...
    const categories = await getBlogCategories(client, 4);
    return (
                        ...
                        <div className='row g-5'>
                            ...
                            <div className='col-sm-6 col-xl-5'>
                                <div className='footer-two__item-adress'>
                                    ...
                                    <ul>
                                        <li>
                                            <h4 className='adress-text'>
                                                <a href='#0'>
                                                    No 7, 6th Avenue Gwarinpa,
                                                    Abuja
                                                </a>
                                            </h4>
                                        </li>
