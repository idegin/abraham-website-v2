                            ...
                            return <div className="col-lg-6 col-xl-4">
                                <div className="project-three__item">
                                    <div className="project-three__content">
                                        <div className="shape">
                                            <img src="images/shape/project-three-item-shape.png" alt="shape" />
                                        </div>
                                        <div className="icon">
                                        ...
                                        <div className="content">
                                            <h4>.01</h4>
                                            <h4><Link className="hover-link-light" href={`/services/${index}`}>Marketing
                                                strategy</Link></h4>
                                            <p className="mt-15 mb-25">Reedfish bonefish trahira bristlenose catfish, longnose
                                                lancetfish morid.</p>
                                            <Link href={`/services/${index}`} className="arry-btn"><i
                                                className="fa-light fa-arrow-up-right"></i></Link>
                                        </div>
                                    </div>
                                    <div className="image">
                                        <img src="images/project/project-three-image1.jpg" alt="image" />
                                    </div>
                                </div>
                            </div>
