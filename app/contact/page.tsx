                    ...
                    <div className="row g-4 g-xl-0 align-items-center">
                                ...
                                <div className="contact-two__content">
                                    ...
                                    <ul>
                                        <li className="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                            ...
                                            <a href="#0">No 7, 6th Avenue Gwarinpa, Abuja</a>
                                        </li>
                                        <li className="wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            <a href="tel:+2349063504256">+234 9063504256</a>
                                        </li>
                                        <li className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                            ...
                                            <a href="mailto:info@briieconsulting.com">info@briieconsulting.com</a>
                                        </li>
                                    </ul>

                                    {/* Canada Office */}
                                    <h4 className="mt-4 mb-3">Canada</h4>
                                    <ul>
                                        <li className="wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                                            ...
                                            <a href="#0">847 Jalna Blvd, London, Ontario Canada. N6E 2S2</a>
                                        </li>
                        ...
                        <div className="col-xl-6 order-1 order-xl-2">
                            <div className="contact-two__map">
                                <img src="/images/contact/map.png" alt="image" />
                                <div className="location">
                                    <img className="wow bounceIn" src="/images/contact/map-location.png" alt="image" />
                                </div>
                            </div>
                        </div>
                    </div>
